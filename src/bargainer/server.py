...
from base_models import NewConversationPayload, ReplyPayload, ProductPayload
...
@app.post("/products")
async def insert_product(data: ProductPayload):
    return bargainer.create_product(data)